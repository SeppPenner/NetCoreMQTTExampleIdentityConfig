namespace Storage.Dto
{
    ...
    public class DtoCreateUpdateUser
    {
        ...
        {
            return $"{nameof(this.LockoutEnd)}: {this.LockoutEnd}, {nameof(this.TwoFactorEnabled)}: {this.TwoFactorEnabled}, {nameof(this.PhoneNumberConfirmed)}: {this.PhoneNumberConfirmed}, {nameof(this.PhoneNumber)}: {this.PhoneNumber}, {nameof(this.EmailConfirmed)}: {this.EmailConfirmed}, {nameof(this.Email)}: {this.Email}, {nameof(this.UserName)}: {this.UserName}, {nameof(this.Password)}: {this.Password}, {nameof(this.LockoutEnabled)}: {this.LockoutEnabled}, {nameof(this.AccessFailedCount)}: {this.AccessFailedCount}, {nameof(this.ClientIdPrefix)}: {this.ClientIdPrefix}, {nameof(this.ClientId)}: {this.ClientId}";
        }
    }
}